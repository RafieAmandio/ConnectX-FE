...
const startupCardBlueprints: MockDiscoveryStartupCardBlueprint[] = [
  {
    ...
    name: 'PayFlow AI',
    logoUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&auto=format&fit=crop&q=80',
    badgeLabel: 'MVP',
    ...
    memberCount: 2,
    summary: 'We are building a comprehensive, highly robust, AI-powered payment infrastructure specifically designed to empower Small and Medium-sized Enterprises (SMEs) across the diverse landscape of Southeast Asia. In a region heavily characterized by complex regulatory environments, fragmented banking systems, and a rapid shift towards digital commerce, traditional payment solutions often fall short. They are frequently rigid, prohibitively expensive, and lack necessary localized features. Our innovative platform bridges this significant gap by offering a seamless, unified gateway that consolidates a vast array of local payment methods—ranging from popular e-wallets and direct bank transfers to traditional cash options—into a single, intuitive interface. At the core of our solution is an advanced artificial intelligence engine. This cutting-edge AI continuously analyzes transaction patterns to detect and prevent sophisticated fraud in real-time, significantly optimizing approval rates and drastically minimizing financial risk for merchants. Furthermore, the AI provides deeply actionable business insights, helping SMEs understand nuanced customer behavior and meticulously optimize their cash flow management. By leveraging machine learning, we dynamically route transactions through the most reliable and cost-effective channels available at any given moment. Our ultimate mission is to fundamentally democratize access to enterprise-grade financial technology, enabling ambitious local businesses to scale effortlessly, reduce operational overhead, and focus wholeheartedly on growing their vibrant businesses and actively serving their communities in an interconnected digital economy.',
  ...
  },
  {
    ...
    logoUrl: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1200&auto=format&fit=crop&q=80',
    badgeLabel: 'Pre-Seed',
  ...
  },
  {
    ...
    name: 'Cargo OS',
    logoUrl: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&auto=format&fit=crop&q=80',
    badgeLabel: 'Seed',
  ...
  },
  {
    ...
    name: 'Aurora Stack',
    logoUrl: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200&auto=format&fit=crop&q=80',
    badgeLabel: 'MVP',
  ...
  },
  {
    ...
    name: 'People OS',
    logoUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&auto=format&fit=crop&q=80',
    badgeLabel: 'MVP',
